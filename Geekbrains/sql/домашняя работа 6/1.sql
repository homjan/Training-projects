...
INSERT INTO `cat` VALUES (1,'Процессоры'),(2,'Материнские платы'),(3,'Видеокарты');
...
INSERT INTO `catalogs` VALUES (1,'Процессоры'),(2,'Мат.платы'),(3,'Видеокарты'),(4,'Блоки питания'),(5,'Корпуса');
...
CREATE TABLE `flights` (
  `id` int DEFAULT NULL,
  `fromm` varchar(256) DEFAULT NULL,
  `too` varchar(256) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,2,NULL,NULL),(2,2,NULL,NULL),(3,3,NULL,NULL);
...
INSERT INTO `products` VALUES (1,'Процессор 1',NULL,1000.00,1,NULL,NULL),(2,'Видеокарта 1',NULL,800.00,3,NULL,NULL),(3,'Видеокарта 1',NULL,600.00,3,NULL,NULL);
...
INSERT INTO `storehouses_products` VALUES (1,54,628,5),(2,58,629,0),(3,59,636,12),(4,62,639,0);
...
CREATE TABLE `users` (
  ...
  `updated_at` varchar(63) DEFAULT NULL
...
INSERT INTO `users` VALUES (2,'Петров','1974-11-25','20.10.2017 8:10','12.05.2018 16:25'),(10,'Сидоров',NULL,NULL,NULL),(24,'Кузнецов',NULL,NULL,NULL);
...
-- Dump completed on 2020-04-09 16:03:18
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
...
LOCK TABLES `users` WRITE;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` VALUES (1,'Иванов','1985-05-10','20.10.2017 8:10','12.07.2018 18:50');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
